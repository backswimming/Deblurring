...
%     ri=rj;
% end
% m_deblur(:,:,k)=rot90(reshape(xi,N,N),2);
% end
im_deblur_CG = squeeze(sos(m_deblur,3));
haha=real2jpg(im_deblur_CG);
haha_p=haha(30:138,25:138);
haha(30:138,25:138)=histeq(haha_p);
figure;
% imshow(abs(im_deblur_CG),[]);
imshow(haha);
title('deblurring-invivo_r-3.5mm(histeq)');
